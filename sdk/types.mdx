...
| `widgetUrl`      | `string`                       | No       | `'https://widget.transcrypts.com'` | Custom widget URL. Use this to point to a staging or self-hosted widget instance.         |
...
| `verificationId` | `string`                                     | No       | The unique verification identifier. Format: `ver_{timestamp}`.                     |
