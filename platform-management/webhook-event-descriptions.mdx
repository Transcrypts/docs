...
**Event Types:** `statements-created`, `shifts-created`, `bank-accounts-created`

Include an `objects_count` field indicating the number of associated objects created.

### Statements, Shifts, and Bank Accounts Updated

**Event Types:** `statements-updated`, `shifts-updated`, `bank-accounts-updated`
