...
Generate a fresh key in the [Transcrypts Dashboard](http://dashboard.transcrypts.com/app/development/keys).
...
<Info>
Create a sandbox key first to validate your integration before updating production credentials.
</Info>
