...
<CardGroup cols={2}>
  ...
  <Card title="Widget Events" icon="bell" href="/widget/events">
    Subscribe to real-time events from the verification widget.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Customization" icon="palette" href="/widget/customization">
    Style the widget overlay to match your application.
  </Card>
</CardGroup>
